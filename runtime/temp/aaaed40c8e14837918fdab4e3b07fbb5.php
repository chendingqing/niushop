...
<div class="set-style">
	...
	<dl>
		...
		<dd>
			<p><input id="category_name" type="text" value="<?php echo $data['category_name']; ?>" placeholder="请输入商品分类" class="input-common"></p>
	...
	<dl>
		...
		<dd>
			<p><input id="short_name" type="text" value="<?php echo $data['short_name']; ?>" placeholder="请输入商品分类简称" class="input-common"></p>
	...
	<dl>
		<dt>排序：</dt>
		<dd>
			<p><input id="sort" type="number"value="<?php echo $data['sort']; ?>" placeholder="请输入序号" class="input-common harf"></p>
		</dd>
	</dl>
	<dl>
		<dt>图片：</dt>
		<dd>
			<div class="upload-btn-common">
				...
				<input type="text" id="text_logo" class="input-common" readonly="readonly" value="<?php if($data['category_pic']): ?><?php echo $data['category_pic']; endif; ?>" />
				<em>上传</em>
				
				<img id="preview_logo" src="__STATIC__/blue/img/upload-common-select.png" <?php if($data['category_pic']): ?>data-src="<?php echo __IMG($data['category_pic']); ?>"<?php endif; ?> data-html="true" data-container="body" data-placement="top" data-trigger="manual"/>
	...
	<dl>
		<dt>关键字：</dt>
		<dd>
			<p><input id="keywords"  placeholder="请输入关键字" class="input-common long" value="<?php echo $data['keywords']; ?>"></p>
	...
	<dl>
		<dt>描述：</dt>
		<dd>
			<p><textarea id="description" placeholder="请输入描述" class="textarea-common"><?php echo $data['description']; ?></textarea></p>
		</dd>
	</dl>
	<dl>
		<dt>电脑端分类页面模板：</dt>
		<dd>
			<?php echo $template_url['pc_template_url']; ?>&nbsp;<input type="text" class="input-common harf" name="" value="<?php echo $data['pc_custom_template']; ?>" id="pc_custom_template" style="width: 80px;" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')">&nbsp;.html
	...
	<dl>
		<dt>手机端分类页面模板：</dt>
		<dd>
			<?php echo $template_url['wap_template_url']; ?>&nbsp;<input type="text" class="input-common harf" name="" value="<?php echo $data['wap_custom_template']; ?>" id="wap_custom_template" style="width: 80px;" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')">&nbsp;.html
...
function updateGoodsCategoryAjax() {
	...
	if(verify(category_name,short_name, keywords, sort, description)){
		$.ajax({
			type : "post",
			url : "<?php echo __URL('ADMIN_MAIN/goods/updategoodscategory'); ?>",
			data : {
